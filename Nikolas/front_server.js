...
app.get('/choose', function(req, res) {
  var restaurant = req.params.restaurant
    axios.get('http://127.0.0.1:5000/randomrestaurant' + restaurant) //concatenate the desired hero name from the body to end of the api to get information about them
    .then((response)=>{
    var restaurant = response.data; //saves the resposne to the variable
    var tagline = "Displaying the randomly selected resturant:";
